// jquery.sharebox.js
(function(b){var a=function(d){var e=a.defaults,g=a.services;this.each(function(){var a=b(this),h={url:a.data("url"),title:a.data("title"),services:a.data("services")},k=b.extend({},e,h,d),h=k.services.split(" "),f=a.find("ul.sharebox-buttons");f.length||(f=b("<ul></ul>").addClass("sharebox-buttons").appendTo(a));b.each(h,function(d,a){a=a.replace("google+","google-plus");var c=g[a];if(c){var e=f.find("li.share-"+a);e.length||(e=b("<li></li>").addClass("share-"+a).appendTo(f));e.append(b("<a></a>").attr({href:b.isFunction(c.url)?
...
width:500,height:300,url:function(a){return"https://pinterest.com/pin/create/link/?url={URL}&description={TITLE}".replace("{URL}",encodeURIComponent(a.url)).replace("{TITLE}",encodeURIComponent(a.title))},click:a.popup},reddit:{label:"Reddit",width:500,height:300,url:function(a){return"https://reddit.com/submit?url={URL}&title={TITLE}".replace("{URL}",encodeURIComponent(a.url)).replace("{TITLE}",encodeURIComponent(a.title))},click:a.popup},stumbleupon:{label:"StumbleUpon",width:500,height:300,url:function(a){return"https://www.stumbleupon.com/submit?url={URL}&title={TITLE}".replace("{URL}",
encodeURIComponent(a.url)).replace("{TITLE}",encodeURIComponent(a.title))},click:a.popup},tumblr:{label:"Tumblr",width:500,height:300,url:function(a){return"https://www.tumblr.com/share/link?url={URL}&name={TITLE}&description=".replace("{URL}",encodeURIComponent(a.url)).replace("{TITLE}",encodeURIComponent(a.title))},click:a.popup},twitter:{label:"Twitter",width:500,height:300,url:function(a){return"https://twitter.com/intent/tweet?url={URL}&text={TITLE}".replace("{URL}",encodeURIComponent(a.url)).replace("{TITLE}",
encodeURIComponent(a.title))},click:a.popup},print:{label:"Print",url:"#",click:function(){window.print();return!1}}};b.fn.sharebox=a})(jQuery);
